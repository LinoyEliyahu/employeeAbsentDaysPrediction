...
# First and Last Names of student: Linoy Eliyahu
    ...
    *** Mandatory structure ***
    ...
    def fit(self, dataset_df):
        ...
        *** This method will be called exactly once during evaluation. See the main section for details ***
        ...
        numerical_columns = ['Season', 'Height', 'Transportation expense','Pet', 'Weight','Son','Service time', 'Transportation expense',
                            'Day', 'Month', 'Reason', 'ID'] # There are more - what else?
...
def train_model(processed_X, y):
    ...
    model = DecisionTreeClassifier(criterion="entropy",
                           random_state=42, max_depth=4, max_features=0.7, min_samples_leaf=1, min_samples_split=2)
  
    fity = model.fit(processed_X, y)
    return model
